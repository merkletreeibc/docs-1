---
title: "Introduction to the Cosmos SDK"
...
Cosmos EVM is a module of the Cosmos SDK, the most widely-adopted Layer 1 framework for building blockchains. It allows you to build application-specific blockchains with the modular Cosmos SDK framework. Create custom blockchain applications with ease using pre-built and custom modules. 

## What You Can Build with the Cosmos SDK
...
In addition to the Cosmos EVM module, the Cosmos SDK includes several battle-tested core modules:
...
<CardGroup cols={2}>
  ...
  <Card title="Developer Discord" icon="message-circle">
    ...
    <a href="http://discord.gg/interchain">Join Discord→</a>
  </Card>
</CardGroup>
